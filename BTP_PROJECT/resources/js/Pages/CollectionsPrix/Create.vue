...
const currentPageTitle = ref("Nouvelle Collecte de Prix")
...
<template>
    <Head title="Nouvelle Collecte Prix" />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <select id="commune_id" v-model="form.commune_id"
                                                @change="loadArrondissements" required
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <p class="text-xs text-gray-500">
                                                Nom du magasin, marché ou lieu de vente
                                            </p>
                                        </div>
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <textarea id="detail" v-model="form.detail"
                                                placeholder="Informations complémentaires, conditions de vente, observations..."
                                                rows="3"
                                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100"
                                                :class="{ 'border-red-300': form.errors.detail }"></textarea>
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <p class="text-xs text-gray-500">
                                                Soyez précis : marque, qualité, dimensions, couleur, etc.
                                            </p>
                                        </div>
                                        ...
                                        <!-- Aperçu du prix -->
                                        <div v-if="form.price && form.devise_id"
                                        ...
                                        <div class="p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800 rounded-lg">
                                            <p class="text-sm text-blue-800 dark:text-blue-300">
                                                ℹ️ Votre collecte sera enregistrée en attente de validation par un administrateur.
                                            </p>
                                        </div>
                                    </div>
                                </div>
