                ...
                <div
                    ...
                    <Card class="border-0 shadow-none">
                        ...
                        <CardContent class="px-0">
                            <form @submit.prevent="form.put(route('corps-etat.update', corpsEtat.id))"
                                class="space-y-6">

                                <!-- Intitulé -->
                                <div class="space-y-2">
                                    <Label for="intitule">Intitulé *</Label>
                                    <Input id="intitule" v-model="form.intitule" placeholder="Ex : Gros œuvre" />
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input id="ordre" type="number" v-model="form.ordre" placeholder="Ex : 1" />
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input id="sous_total" type="number" step="0.01" v-model="form.sous_total"
