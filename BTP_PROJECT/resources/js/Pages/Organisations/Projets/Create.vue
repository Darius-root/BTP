                    ...
                    <Card class="border-0 shadow-none">
                        <CardHeader class="px-0 pt-0">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                <div>
                                    <CardTitle class="text-3xl">Créer un projet</CardTitle>
                                    <CardDescription class="mt-1">
                                        Remplissez les informations pour le nouveau projet. Le code sera généré automatiquement.
                                    </CardDescription>
                                </div>
                        ...
                        <CardContent class="px-0">
                            <form @submit.prevent="submit" class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xs text-gray-500">Le code projet sera généré automatiquement à partir de ce nom</p>
                                </div>
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                    ...
                                    <Button type="submit" :disabled="form.processing" class="bg-blue-600 hover:bg-blue-700">
                                        <span v-if="form.processing" class="flex items-center">
                                            <Loader2 class="w-4 h-4 mr-2 animate-spin" /> Création...
                                        </span>
                                        <span v-else class="flex items-center">
                                            <Plus class="w-4 h-4 mr-2" /> Créer le projet
                                        </span>
                                    </Button>
                                </div>
                            </form>
...
const submit = () => {
    form.post(route('projets.store'), { preserveScroll: true })
}
</script>
