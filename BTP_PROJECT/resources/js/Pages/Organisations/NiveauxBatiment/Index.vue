                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="relative mt-1">
                                            ...
                                            <Input id="searchFilter" v-model="globalFilter" type="text"
                                                placeholder="Code, nom..." class="pl-10 pr-10 w-full"
                                                autocomplete="off" />
...
const filteredData = computed(() => {
    if (!globalFilter.value) return props.niveaux.data

    const searchTerm = globalFilter.value.toLowerCase()

    return props.niveaux.data.filter(
        (n) =>
...
const confirmDelete = (niveau) => {
    if (
        confirm(
            `Êtes-vous sûr de vouloir supprimer le niveau "${niveau.nom}" ? Cette action est irréversible.`
        )
    ) {
