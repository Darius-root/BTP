...
<template>
  ...
  <SidebarProvider>
    <AdminLayout>
      <PageBreadcrumb :pageTitle="'Créer un Devis Estimatif'" />
        ...
        <Card>
          ...
          <CardContent class="space-y-4">
            ...
            <div v-for="(niveau, nIndex) in form.niveaux" :key="nIndex" class="border p-4 rounded space-y-4 bg-gray-50">
              ...
              <span v-if="form.errors[`niveaux.${nIndex}.niveau_id`]" class="text-red-600 mb-4 text-sm">
                {{ form.errors[`niveaux.${nIndex}.niveau_id`] }}
              </span>

              <!-- Composants -->
              <div v-for="(comp, cIndex) in niveau.composants" :key="cIndex" class="grid grid-cols-7 gap-2 items-stretch justify-start ">
                <div>
                  <Label>Code</Label>
                  <Input v-model="comp.code" placeholder="ASxx" />
                  <span v-if="form.errors[`niveaux.${nIndex}.composants.${cIndex}.code`]" class="text-red-600 text-sm text-wrap">
                ...
                <div class="col-span-2">
                  ...
                  <span v-if="form.errors[`niveaux.${nIndex}.composants.${cIndex}.piece`]" class="text-red-600 text-sm">
                ...
                <div>
                  ...
                  <span v-if="form.errors[`niveaux.${nIndex}.composants.${cIndex}.unite_id`]" class="text-red-600 text-sm">
                ...
                <div>
                  ...
                  <span v-if="form.errors[`niveaux.${nIndex}.composants.${cIndex}.qte`]" class="text-red-600 text-sm">
                ...
                <div>
                  ...
                  <span v-if="form.errors[`niveaux.${nIndex}.composants.${cIndex}.prix_unitaire`]" class="text-red-600 text-sm">
